...
<body>
  ...
  <div class="container">
    ...
    <div class="card">
      ...
      <input type="hidden" value="technician" name="identifier"/>
    ...
    <div class="card alt">
      ...
      <form id="" action="addTechnician" method="post">
        <div class="input-container">
    ...
    <div class="input-container">
      ...
      <div class="input-container">
        ...
        <div class="input-container">
          <input type="text" id="technicalDetails" name="technicalDetails" required="required"/>
          <label for="designation">Technical Info</label>
          <div class="bar"></div>
        </div>
        <div class="button-container">
