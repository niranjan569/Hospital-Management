...
<div class="container">
  ...
  <div class="card">
    ...
    <input type="hidden" value="patient" name="identifier">
  ...
  <div class="card alt">
    ...
    <form id="patient" action="addPatient" method="post">
      <div class="input-container">
    ...
    <div class="input-container">
      ...
      <div class="input-container">
        <input type="text" id="medicationDetails" name="medicationDetails" required="required"/>
        <label for="medicalDetails">Medication Details</label>
        <div class="bar"></div>
      </div>
      <div class="button-container">
